...
| `core/mem` | partial v1 | Allocators, fixed arenas, cross-platform virtual memory, virtual growing/static arenas, temp helpers, and trailing guard-page overflow protection landed; specialized allocators and file mapping still remain. |
