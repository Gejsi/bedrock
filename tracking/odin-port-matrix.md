...
| `core/io` | partial v1 | Odin-style single stream proc plus in-memory adapters landed, including generic `read_at`/`write_at`/`size` fallbacks; broader helpers and buffered utilities still remain. |
