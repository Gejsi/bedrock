...
| `core/mem` | partial v1 | Allocators, fixed arenas, cross-platform virtual memory, and virtual growing/static arenas landed; specialized allocators and file mapping still remain. |
