...
| `core/strings` | partial v1 | Initial string view/owned string layer and builder landed with UTF-8-aware rune search/count helpers; reader and broader convenience surface still remain. |
